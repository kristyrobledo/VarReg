...
![CD4 dataset: more variation in the CD4 counts at younger ages than at older ages](figure/cd4p1-1.png)
...
![PlotVarReg example](figure/plotcd4-1.png)
...
![plotVarReg example of best model from search VarReg](figure/plotvarreg2-1.png)
...
![Comparison of residuals](figure/resp-1.png)
...
![Viral load data demonstrating measurement error](figure/viralp-1.png)
